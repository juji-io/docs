...
Engine**, both of which are domain-independent and
industry-agnostic. Developers can access both cognitive AI engines via
API and build their own state-of-the-art cognitive AI applications in
**any domain and industry**.

The [Juji Psychographic Insights API](psychographic-api.md) enables developers
to access the Juji Psychographic Insights Engine, analyzing any text
generated by a person, such as social media posts, blogs, emails,
voice transcripts, and chat text, to automatically infer quantitative
human trait scores. Currently, Juji infers trait scores of fundamental
human personality models (e.g., [Big 5
traits](https://en.wikipedia.org/wiki/Big_Five_personality_traits)) as
well as scores of composite psychographic models (e.g., [Holland
Codes](https://en.wikipedia.org/wiki/Holland_Codes)). Juji
psychographic inference is **domain and industry independent**, which
allows developers to automate psychographic insights discovery and use
the discovered insights to build custom applications in any domain or
tasks, e.g., assessing financial lenders' personality traits and
recommend suitable financial products, discovering students'
psychologic needs and learning style to match-make students and
mentors, and inferring the soft skills and moral characters of police
candidates to determine their fit for a police job role.

On the other hand, the [Juji Cognitive AI Chat
API](cognitive-ai-chatbot-api.md) enables developers to access the
Juji Cognitive AI Chat engine and rapidly create an **end-to-end**
cognitive AI assistant in a form of chatbot in **any domain or
industry**. The API can also be used to embed a cognitive AI assistant
into any third-party application, such as in a mobile application or
