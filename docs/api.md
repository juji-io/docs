...
independent**. Developers can use Juji API to access both cognitive AI
engines and build their own state-of-the-art cognitive AI
applications in **any domain and industry**.

## Juji Psychographic Insights API [Juji Psychographic Insights
API](psychographic-api.md)
