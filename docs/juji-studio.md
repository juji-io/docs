...
You can also click on the elipsis icon (three dots) on the top right corner of the chatbot tile, and perform additional management actions on that chatbot, such as **export**, **import**, **clone**, and **delete**. When you import a chatbot into an existing chatbot, it means that you wish to replace the chatbot's main chat flow or Q&A list with that of another chatbot.

**Design Tip** This function is most useful when you want to share multi-turn Q&As among chatbots because such Q&As cannot be captured by a CSV file but can be exported with a chatbot and then be imported into another chatbot.   
